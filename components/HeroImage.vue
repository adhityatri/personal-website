<template>
  <div
    :class="`relative overflow-hidden flex p-4 ${
      isMobile ? 'w-full justify-center' : 'w-[420px] justify-end'
    }`"
  >
    <div
    ...
    />
    <div
      :class="`z-1 ring-10 mr-4 ring-[#83c5be] relative rounded-[80px] overflow-hidden border-4 border-neutral-100 ${
